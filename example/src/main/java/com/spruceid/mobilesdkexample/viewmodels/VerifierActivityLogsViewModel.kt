...
class LogsViewModel(private val verificationActivityLogsRepository: VerificationActivityLogsRepository) : ViewModel() {
  ...
  init {
    viewModelScope.launch {
      _verificationActivityLogs.value = verificationActivityLogsRepository.verificationActivityLogs
    }
  }
  ...
  suspend fun saveVerificationActivityLog(verificationActivityLogs: VerificationActivityLogs) {
    ...
    _verificationActivityLogs.value = verificationActivityLogsRepository.getVerificationActivityLogs()
  }
...
class LogsViewModelFactory(private val repository: VerificationActivityLogsRepository) : ViewModelProvider.NewInstanceFactory() {
